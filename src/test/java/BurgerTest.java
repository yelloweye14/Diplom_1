...
public class BurgerTest {
    ...
    @Test
    public void isSetBunsSetsCorrectBun() {
    ...
    @Test
    public void isAddIngredientAddsIngredient() {
        Burger burger = new Burger();
    ...
    @Test
    public void isRemoveIngredientRemovesIngredient() {
        Burger burger = new Burger();
        int baseSize = burger.ingredients.size();
    ...
    @Test
    public void isMoveIngredientMovesIngredient() {
        Burger burger = new Burger();
        int baseSize = burger.ingredients.size();
        burger.ingredients.add(ingredient);
